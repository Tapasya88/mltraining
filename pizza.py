...
model.fit(x, y)
print ('A 13" pizza should cost: $%.2f' % model.predict([[10]]))



#Mean Sqaured Error
MSE=np.mean((12-model.predict([[9]]))**2)
print("Mean Sqaured Error %r" %(MSE))



#multiple linear regression diameter and number of toppings -- 1 for training data
